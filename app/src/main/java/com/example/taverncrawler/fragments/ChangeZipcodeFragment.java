 ...
 * Use the {@link ChangeZipcodeFragment#newInstance} factory method to
...
public class ChangeZipcodeFragment extends Fragment {
     ...
     * @return A new instance of fragment ChangeZipcodeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ChangeZipcodeFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonchange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    query.whereEqualTo("zipcode", ParseUser.getCurrentUser());
                    query.setLimit(1);
